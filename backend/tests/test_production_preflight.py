...
def _environment() -> dict[str, str]:
    return {
        ...
        "TON_NETWORK": "mainnet",
        "BACKEND_IMAGE": "ghcr.io/gr1gorii/ton-tracker-backend:0.51.0",
        "FRONTEND_IMAGE": "ghcr.io/gr1gorii/ton-tracker-frontend:0.51.0",
        "APP_PORT": "8080",
...
def test_production_image_refs_are_exact_and_fail_closed():
    ...
    invalid_refs = (
        ...
        "ghcr.io/gr1gorii/ton-tracker-backend:0.51",
        "registry.example/ton-tracker-backend:0.51.0",
    ...
    environment = _environment()
    environment["FRONTEND_IMAGE"] = "ghcr.io/gr1gorii/ton-tracker-frontend:0.51.1"
